...
if(isNaN(quantiteParRepas1) || quantiteParRepas1.length==0 )
{
  errorQuantiteParRepas1.innerHTML="merci d'ecrire juste des nombres";
...
//   document.getElementById("quantiteParRepas1").parentElement.style.border = "solid 1px #e8e8e9";
// }
if (isNaN(nombre_de_repas1) || nombre_de_repas1.length==0)
{
  errorNombreDeRepas1.innerHTML="merci d'ecrire juste des nombres";
