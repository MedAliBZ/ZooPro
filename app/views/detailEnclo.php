...
<body>
    ...
    <main>
                            ...
                            <div class="hero-cap hero-cap2 pt-70">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" id="encloName"></a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <section class="support-company-area fix pb-padding">
            <div class="support-wrapper align-items-center">
                <div class="left-content">
                    ...
                    <li> Id Enclos : <span id="idEnclos"></span></li>
                    <li> Appellation Enclos : <span id="appellationEnclos"></span></li>
                    <li> Localisation Enclos : <span id="localisationEnclos"></span></li>
                    <li> Taille Enclos : <span id="tailleEnclos"></span></li>
                    <li> Date construction de l'enclos : <span id="DCEnclos"></span></li>
                    </ul>
                    </div>
                </div>
        ...
        <li><a href="<?php echo URLROOT ?>/typeEnclos/afficherList">enclos</a></li>
