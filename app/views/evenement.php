...
<body>
    ...
    <main>
                            ...
                            <div class="hero-cap hero-cap2 pt-70">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">les evenements</a></li>
        ...
        <div class="section-top-border">
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <h3 class="mb-30">Participation</h3>
                    <form action="#">
                        <div class="mt-10">
                        ...
                        <div class="mt-10">
                            <input type="text" name="event" placeholder="event name" onfocus="this.placeholder = ''"
                                onblur="this.placeholder = 'event name'" required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="text" name="nb" placeholder="nombre de places" onfocus="this.placeholder = ''"
                                onblur="this.placeholder = 'nombre de places'" required class="single-input">
                        </div>
        ...
        <button class="btn" name="participer">Participer</button>           
