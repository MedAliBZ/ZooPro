                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-11">
                        <div class="single-cat text-center mb-30">
                            <div class="cat-icon">
                                <img src="<?php echo URLROOT ?>/public/assets/img/gallery/services1.png" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-11">
                        <div class="single-cat active text-center mb-30">
                            <div class="cat-icon">
                                <img src="<?php echo URLROOT ?>/public/assets/img/gallery/services2.png" alt="">
                            </div>
                            <div class="cat-cap">
        ...
        <section class="support-company-area fix pt-10">
            <div class="support-wrapper align-items-center">
                ...
                <div class="right-content">
                    <!-- img -->
                    <div class="right-img">
                        <img src="<?php echo URLROOT ?>/public/assets/img/gallery/safe_in.png" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo URLROOT ?>/public/assets/img/gallery/case1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases mb-40">
                            <div class="cases-img">
                                <img src="<?php echo URLROOT ?>/public/assets/img/gallery/case2.png" alt="">
                            </div>
                            <div class="cases-caption">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cases">
                            <div class="cases-img">
                                <img src="<?php echo URLROOT ?>/public/assets/img/gallery/case3.png" alt="">
                            </div>
                            <div class="cases-caption">
                                <h3><a href="#">Wildlife in Danger</a></h3>
                                <p>Interdum nulla, ut commodo diam libero vitae
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo URLROOT ?>/public/assets/img/gallery/home-blog1.png" alt="">
                                </div>
                                <div class="blog-cap">
                                    <h3><a href="#">Leverage agile frameworks to provide a robust synopsis</a></h3>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="<?php echo URLROOT ?>/public/assets/img/gallery/home-blog2.png" alt="">
                                </div>
                                <div class="blog-cap">
                                    <h3><a href="#">Leverage agile frameworks to provide a robust synopsis</a></h3>
                                    <p>The automated process starts as soon as your clothes go into the machine. Duis cursus, mi quis viverra ornare.</p>
