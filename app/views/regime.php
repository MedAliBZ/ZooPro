            ...
            <div class="card">
                ...
                <div class="form-popup" id="myForm">
                    <form action="<?php echo URLROOT; ?>/regimeC/addRegimeC" class="form-container" method="POST">
                        ...
                        <div class="formCss">
                            <input placeholder="type Nourriture" type="text" id="typeNourriture" name="type_nourriture">
                        </div>
                        <div class="formCss">
                            <input placeholder="quantité par repas(kg)" type="text" id="quantiteParRepas" name="quantite_par_repas">
                        </div>
