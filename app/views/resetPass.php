...
<body>
    ...
    <div class="container">
        ...
        <div class="right-div">
            <h4>Welcome Back</h4>
            <form action="<?php echo URLROOT; ?>/users/chercherEmail" method="POST" class="right-form">
            ...
            <div class="footer">
                <ul>
                    ...
                    <li><a href="<?php echo URLROOT; ?>/pages/getUsername">Nom d'utilisateur oublié?</a></li>
                </ul>
            </div>
